...
// Now takes reflectivity [0 1] as a parameter (0 means no reflectivity)
// Also modified to make the plane double-sided with the underside of the plane being semi-transparent (like MuJoCo)
